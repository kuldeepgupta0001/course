...
const Founder = () => (
  <Stack direction={["column", "row"]} spacing={["2", "8"]} padding={"8"}>
    <VStack>
      <Avatar
        src="https://avatars.githubusercontent.com/u/131482835?v=4"
        boxSize={["40", "48"]}
      />
      <Text children="Co-Founder" opacity={"0.7"} />
    </VStack>
    <VStack justifyContent={"center"} alignItems={["center", "flex-start"]}>
      <Heading children="Kuldeep Kumar Gupta" size={["md", "xl"]} />
      <Text
        textAlign={["center", "left"]}
